...
export const getAllRecords = async (req, res, next) => {
  try {
    ...
    return sendPaginated(res, records, total, filters.page, filters.limit, 'Records fetched successfully');
  } catch (error) { next(error); }
};
...
export const getMyRecords = async (req, res, next) => {
  try {
    ...
    return sendPaginated(res, records, total, filters.page, filters.limit, 'Your records fetched successfully');
  } catch (error) { next(error); }
};
